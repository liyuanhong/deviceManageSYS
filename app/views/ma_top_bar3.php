...
<div id="ctrl_div2">
  <button id="ctrl_div2_all" onclick="searchDevice(event)" <?php if($ma_page_man=="ma_page_man_all"){echo 'class="ma_page_man"';} ?>>所有手机</button>
  <button id="ctrl_div2_borrowing" onclick="searchDevice(event)" <?php if($ma_page_man=="ma_page_man_borrowing"){echo 'class="ma_page_man"';} ?>>借出手机</button>
  <button id="ctrl_div2_noborrow" onclick="searchDevice(event)" <?php if($ma_page_man=="ma_page_man_noborrowing"){echo 'class="ma_page_man"';} ?>>剩余手机</button>
